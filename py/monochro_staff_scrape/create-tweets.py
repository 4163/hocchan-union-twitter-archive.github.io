...
profile_picture = "Media/@monochro_staff/ZB1SEsrq_400x400.jpg"
username = "ミス・モノクロームSTAFF"
handle = "@monochro_staff"
minify_html = True  # Set to True to minify the HTML output

# Step 1: Read the Excel file
cwd = os.getcwd()
excel_file = os.path.join(cwd, '2013.xlsx')  # Adjusted the filename to your context
