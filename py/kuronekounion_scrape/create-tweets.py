...
profile_picture = "Media/@kuronekounion/XvNxwvo4_400x400.jpg"
username = "黒ネコ同盟(堀江由衣&スタッフ)"
handle = "@kuronekounion"
minify_html = True  # Set to True to minify the HTML output

# Step 1: Read the Excel file
cwd = os.getcwd()
excel_file = os.path.join(cwd, '2010.xlsx')  # Adjusted the filename to your context
